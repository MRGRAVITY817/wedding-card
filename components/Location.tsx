...
const Transportation = () => {
  return (
    <div className="py-8 px-8">
      ...
      <ul className="text-sm flex flex-col gap-2">
        <li className="mt-2">1호선 병점역 3번출구 셔틀버스 이용</li>
        <li>
          병점역 3번출구 주변에 예식고객 전용 셔틀버스 운영 (10:30~20:00)운영
        </li>
        <li>{`병점역 출발 ->10:30 부터 -> 19:30까지운영 (30분간격 출발)`}</li>
        <li>{`희온포레출발 -> 11:00 부터 -> 20시까지 운영 (30분간격 출발)`}</li>
      </ul>
    </div>
  );
};
